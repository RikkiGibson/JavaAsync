...
public interface BlockBlobs {
     ...
     */
    void putBlock(String container, String blob, String blockId, byte[] body);
     ...
     */
    ServiceFuture<Void> putBlockAsync(String container, String blob, String blockId, byte[] body, final ServiceCallback<Void> serviceCallback);
     ...
     */
    Single<Void> putBlockAsync(String container, String blob, String blockId, byte[] body);
    /**
     * The Put Block operation creates a new block to be committed as part of a blob.
     *
     * @param container The container name.
     ...
     * @param body Initial data
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the {@link RestResponse<BlockBlobsPutBlockHeaders, Void>} object if successful.
     */
    Single<RestResponse<BlockBlobsPutBlockHeaders, Void>> putBlockWithRestResponseAsync(String container, String blob, String blockId, byte[] body);
    /**
     * The Put Block operation creates a new block to be committed as part of a blob.
     *
     * @param container The container name.
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    void putBlock(String container, String blob, String blockId, byte[] body, Integer timeout, String leaseId);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Void> putBlockAsync(String container, String blob, String blockId, byte[] body, Integer timeout, String leaseId, final ServiceCallback<Void> serviceCallback);
     ...
     * @return the {@link Single<Void>} object if successful.
     */
    Single<Void> putBlockAsync(String container, String blob, String blockId, byte[] body, Integer timeout, String leaseId);
     ...
     * @return the {@link RestResponse<BlockBlobsPutBlockHeaders, Void>} object if successful.
     */
    Single<RestResponse<BlockBlobsPutBlockHeaders, Void>> putBlockWithRestResponseAsync(String container, String blob, String blockId, byte[] body, Integer timeout, String leaseId);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    void putBlockList(String container, String blob, List<String> blocks);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Void> putBlockListAsync(String container, String blob, List<String> blocks, final ServiceCallback<Void> serviceCallback);
     ...
     * @return the {@link Single<Void>} object if successful.
     */
    Single<Void> putBlockListAsync(String container, String blob, List<String> blocks);
    /**
     * The Put Block List operation writes a blob by specifying the list of block IDs that make up the blob. In order to be written as part of a blob, a block must have been successfully written to the server in a prior Put Block operation. You can call Put Block List to update a blob by uploading only those blocks that have changed, then committing the new and existing blocks together. You can do this by specifying whether to commit a block from the committed block list or from the uncommitted block list, or to commit the most recently uploaded version of the block, whichever list it may belong to.
     *
     * @param container The container name.
     ...
     * @param blocks the List&lt;String&gt; value
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the {@link RestResponse<BlockBlobsPutBlockListHeaders, Void>} object if successful.
     */
    Single<RestResponse<BlockBlobsPutBlockListHeaders, Void>> putBlockListWithRestResponseAsync(String container, String blob, List<String> blocks);
    /**
     * The Put Block List operation writes a blob by specifying the list of block IDs that make up the blob. In order to be written as part of a blob, a block must have been successfully written to the server in a prior Put Block operation. You can call Put Block List to update a blob by uploading only those blocks that have changed, then committing the new and existing blocks together. You can do this by specifying whether to commit a block from the committed block list or from the uncommitted block list, or to commit the most recently uploaded version of the block, whichever list it may belong to.
     *
     * @param container The container name.
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Void> putBlockListAsync(String container, String blob, List<String> blocks, Integer timeout, String xMsBlobCacheControl, String xMsBlobContentType, String xMsBlobContentEncoding, String xMsBlobContentLanguage, String xMsBlobContentMd5, String xMsMeta, String leaseId, String xMsBlobContentDisposition, DateTime ifModifiedSince, DateTime ifUnmodifiedSince, String ifMatches, String ifNoneMatch, final ServiceCallback<Void> serviceCallback);
     ...
     */
    BlockList getBlockList(String container, String blob);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<BlockList> getBlockListAsync(String container, String blob, final ServiceCallback<BlockList> serviceCallback);
     ...
     */
    Single<BlockList> getBlockListAsync(String container, String blob);
    /**
     * The Get Block List operation retrieves the list of blocks that have been uploaded as part of a block blob.
     *
     * @param container The container name.
     ...
     * @return the observable to the BlockList object
     */
    Single<RestResponse<BlockBlobsGetBlockListHeaders, BlockList>> getBlockListWithRestResponseAsync(String container, String blob);
    /**
     * The Get Block List operation retrieves the list of blocks that have been uploaded as part of a block blob.
     *
     * @param container The container name.
     ...
     * @return the BlockList object if successful.
     */
    BlockList getBlockList(String container, String blob, DateTime snapshot, BlockListType listType, Integer timeout, String leaseId);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<BlockList> getBlockListAsync(String container, String blob, DateTime snapshot, BlockListType listType, Integer timeout, String leaseId, final ServiceCallback<BlockList> serviceCallback);
     ...
     * @return the observable to the BlockList object
     */
    Single<BlockList> getBlockListAsync(String container, String blob, DateTime snapshot, BlockListType listType, Integer timeout, String leaseId);
     ...
     * @return the observable to the BlockList object
     */
    Single<RestResponse<BlockBlobsGetBlockListHeaders, BlockList>> getBlockListWithRestResponseAsync(String container, String blob, DateTime snapshot, BlockListType listType, Integer timeout, String leaseId);
